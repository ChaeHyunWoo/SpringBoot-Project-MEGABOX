...
%>
<!DOCTYPE html>
<!-- saved from url=(0040)https://www.megabox.co.kr/support/notice -->
<html lang="ko">
<!--<![endif]-->
<head>
...
<link rel="stylesheet" href="resources/notice_files/megabox.min.css"
	media="all">
<!-- Global site tag (gtag.js) - Google Analytics -->
<script type="text/javascript" async=""
	src="resources/notice_files/analytics.js.다운로드"></script>
<script type="text/javascript" async="" src="resources/notice_files/js"></script>
<script async="" src="resources/notice_files/js(1)"></script>
...
<script src="resources/notice_files/megabox.api.min.js.다운로드"></script>
<script src="resources/notice_files/lozad.min.js.다운로드"></script>
<script src="resources/notice_files/megabox.common.min.js.다운로드"></script>
<script src="resources/notice_files/megabox.netfunnel.min.js.다운로드"></script>
<script src="resources/notice_files/persona.js.다운로드" async=""></script>
...
<script src="resources/notice_files/ui.common.js.다운로드"></script>
<script
	src="resources/notice_files/wkd5NqRc_DRElZQpV_wE9v0cUpDLDqvNbcXf2TERk5CEAM4qWzAZAbZTZUV4Q2ljRlMzT1Vuc3dzS3ZQXzVnAstB2J1p9ES1FQPLQdidafREtRU.js.다운로드"></script>
<script src="resources/notice_files/front.js.다운로드"></script>
</head>

<body _c_t_common="1">

	<div class="skip" title="스킵 네비게이션">
		<a href="https://www.megabox.co.kr/support/notice#contents"
			title="본문 바로가기">본문 바로가기</a> <a
			href="https://www.megabox.co.kr/support/notice#footer"
...
<script type="text/javascript" src="https://static.nid.naver.com/js/naveridlogin_js_sdk_2.0.0.js" charset="utf-8"></script> -->
		<script src="resources/notice_files/hmac-sha256.js.다운로드"></script>
		<script src="resources/notice_files/enc-base64-min.js.다운로드"></script>
		<script type="text/javascript">
/*전역변수
아이디
패스워드  입력 완료 체크 변수 필요
...
$(function(){
    $("div.sns-login > a").off("click").on("click",function(){
		...
		<div style="display: none;">
			<a id="loginPupupATag"
				href="https://www.megabox.co.kr/support/notice#layer_login_select"
				class="button active btn-modal-open" w-data="850" h-data="484"></a>
		</div>

		<section id="layer_login_select" class="modal-layer"
			style="z-index: 501;">
			<a href="https://www.megabox.co.kr/support/notice" class="focus">레이어로
				포커스 이동 됨</a><a href="https://www.megabox.co.kr/support/notice#"
			...
			<div class="wrap"
				...
				<div class="layer-con" style="height: 511px;">
					...
					<div class="tab-list tab-layer">
						<ul>
							<li class="on"><a
								href="https://www.megabox.co.kr/support/notice#login_tab_01"
								title="회원 로그인 선택">회원 로그인<!--회원 로그인--></a></li>
							<li><a
								href="https://www.megabox.co.kr/support/notice#login_tab_02"
					...
					<div class="tab-cont-wrap">
						...
						<div id="login_tab_01" class="tab-cont on">
							<a href="https://www.megabox.co.kr/support/notice" class="ir"></a><a
								href="https://www.megabox.co.kr/support/notice" class="ir"
								title="로그인"></a>
						...
						<div id="login_tab_02" class="tab-cont">
							...
							<div class="login-member col-2">
								...
								<div class="btn-group">
									...
									<a id="aNonMbLogin"
										href="https://www.megabox.co.kr/support/notice#layer_no_member_chk"
    ...
    -->
		...
		<form name="moveFrm" method="post">
			...
			<input type="hidden" name="bbsNo" value="9"> <input
				type="hidden" name="cateNo"> <input type="hidden"
				name="theater"> <input type="hidden" name="cate2No">
			<input type="hidden" name="theater02"> <input type="hidden"
				name="searchTxt"> <input type="hidden" name="currentPage"
				value="">
		</form>
		...
		<footer id="footer">
			...
			<div class="footer-top">
				<div class="inner-wrap">
					...
					<a
						href="https://www.megabox.co.kr/support/notice#layer_looking_theater"
